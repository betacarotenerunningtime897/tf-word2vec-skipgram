# 🎉 tf-word2vec-skipgram - Create Word Embeddings Easily

## 🚀 Getting Started

Welcome to the **tf-word2vec-skipgram** project! This tool lets you create word embeddings using the Word2Vec Skip-Gram model. You can train your own word embeddings from scratch, and we provide utilities for visualization to help you understand how your model performs.
...
- **Train Word Embeddings:** Use the Skip-Gram model to develop high-quality word embeddings.
- **Negative Sampling:** Efficiently optimize your model using negative sampling techniques.
- **Visualization Tools:** Easily visualize the relationships between words using the included utilities.
- **Text8 Corpus:** Train your models on the popular Text8 dataset for meaningful results.
...
- **Disk Space:** Approximately 200 MB for installation and additional space for your datasets.
...
3. **Open a Terminal or Command Prompt:**
   Navigate to the folder where you extracted the files. You can do this by typing `cd path/to/your/folder`.
...
Once training is complete, you can leverage the visualization tools provided in the `utils` folder. These tools help you understand the relationships between different words in your embedding space.
...
If you want to contribute, feel free to fork the repository and submit a pull request. You can also open an issue if you have suggestions or find bugs.
